...
function filterSelection(c) {
  var x, i;
  x = document.getElementsByClassName("contain-items");
  if (c == "all") c = "";
...
var btnContainer = document.getElementById("ctn-btn-review");
var btns = btnContainer.getElementsByClassName("btn-review");
for (var i = 0; i < btns.length; i++) {
  btns[i].addEventListener("click", function(){
    var current = document.getElementsByClassName("btn-color");
    current[0].className = current[0].className.replace(" btn-color", "");
